                ...
                {loading ? (
                    ...
                    <>
                        ...
                        <div className="summary-grid">
                            <div className="glass-card summary-card" style={{ animationDelay: '0.1s' }}>
                            ...
                            <div className="glass-card summary-card" style={{ animationDelay: '0.2s' }}>
                            ...
                            <div className="glass-card summary-card" style={{ animationDelay: '0.3s' }}>
                                <div className="summary-icon primary">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                            ...
                            <div className="glass-card summary-card" style={{ animationDelay: '0.4s' }}>
                                <div className="summary-icon accent">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                        ...
                        <div className="bottom-grid">
                                        ...
                                        <tbody>
                                            {courses.map((c) => (
                                                <tr key={c.courseId}>
                                                    ...
                                                    <td>
                                                        <Link to={`/teacher-classroom/${c.courseId}`} className="btn btn--accent" style={{ fontSize: '11px', padding: '6px 12px' }}>
                                                            Manage
                                                        </Link>
                                                    </td>
                                                </tr>
                            ...
                            <div className="glass-card schedule-card">
                                <h2 className="schedule-header">Live Schedule</h2>
